from pw3.course_menu.add_course import add_course
from pw3.course_menu.del_course import del_course
from pw3.course_menu.view_update_course import view_update_course
